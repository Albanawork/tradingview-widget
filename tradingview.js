    ...
    function i(r) {
        ...
        class u {
            ...
            _replaceScript(i) {
                ...
                this.iframe = this._createIframe(C, c, a, E, I), this._addCSPErrorListener(c), u && this.iframe.setAttribute("nonce", u);
                const L = this.iframeContainer.querySelector(".tradingview-widget-container__widget");
                if (L ? ((0, t.ensureNotNull)(L.parentElement).replaceChild(this.iframe, L), s?.remove()) : f ? (this.iframeContainer.appendChild(this.iframe), s?.remove()) : (this.iframeContainer.appendChild(this.iframe), h.replaceChild(this.iframeContainer, (0, t.ensureNotNull)(s))), this.shouldListenToIframeResize && function(t, e, i) {
        ...
        new class extends u {
            ...
            get propertiesToWorkWith() {
                return ["colorTheme", "customer", "height", "isTransparent", "largeChartUrl", "locale", "showSymbolLogo", "symbolsGroups", "width", "backgroundColor"]
            }
        }
    })()
})();
